...
class TestProbeSpec extends TestKit(ActorSystem("TestProbeSpec"))
  ...
  "send the work to the slave actor" in {
    ...
    // we are testing the interaction between the master and the slave actor
...
object TestProbeSpec {
  ...
  // class Slave extends Actor ... - don't need to worry about Slave, as Master is System Under Test
}
